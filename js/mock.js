...
export function generateMockResponse(inputText, options = {}) {
  ...
  if (mentionsTokens && charCount > 40) {
    const friendly = [
      "Token คือชิ้นข้อความเล็ก ๆ ที่โมเดลใช้คิด ไม่ใช่คำเต็มเสมอไป ภาษาไทยมักถูกหั่นละเอียดกว่าภาษาอังกฤษ",
      "หน้าต่างบริบทคือความจุต่อรอบ ถ้าข้อความยาวเกินลิมิต ส่วนที่ล้นโมเดลจะอ่านไม่ถึง",
