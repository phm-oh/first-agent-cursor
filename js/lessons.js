...
const FALLBACK_LESSONS = [
  {
    id: "token-basics",
    title: "Token คืออะไร",
    hint: "บทแรก: Token ไม่ใช่คำ — เทียบภาษาไทยกับอังกฤษ",
    modelId: "model-a",
    system:
    ...
    turns: [
      {
        role: "user",
        content:
          "ช่วยอธิบายให้หน่อยว่า Token คืออะไร ต่างจากคำอย่างไร และทำไมหน้าต่างบริบทถึงสำคัญเมื่อเราคุยกับแชทบอท\n\nอยากได้ตัวอย่างภาษาไทยกับภาษาอังกฤษสั้น ๆ เพื่อเอาไปสอนในห้องเรียน",
      },
    ],
  },
];
